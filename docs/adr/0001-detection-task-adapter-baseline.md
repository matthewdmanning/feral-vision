...
downloaded through the Ultralytics source adapter as a ten-class COCO-animal
...
only from a verified immutable augmented Dataset Variant Artifact, linked back
